    ...
    return {
        name: 'aurelia-snowpack-plugin',
          ...
          async load({filePath}) {
            ...
            return typescript.transpileModule(sf.getFullText().replace(/@customElement\(__au2ViewDef\)/g, '@customElement({template: __au2ViewDef} )'), tsconfig).outputText;
          },
    };
};